 ...
 */
final class Version20211002200552 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reminder (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, text LONGTEXT NOT NULL, slug VARCHAR(255) NOT NULL, created_on_date DATETIME NOT NULL, INDEX IDX_40374F4012469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
